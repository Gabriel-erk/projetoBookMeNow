    ...
    <div class="login-container">
        <div class="boxLogin">
            <div class="login-logo text-center">
                ...
                {{-- verifica se a váriavel "errors" que o laravel gera tem algum erro (any), se tiver, vai mostrar o que estiver dentro do if, ou seja, vai mostrar todos os erros --}}
                @if ($errors->any())
            ...
            <form method="post" action="{{ route('login') }}">
                ...
                <div class="mb-3">
                    <label form="senha" class="form-label">Senha</label>
